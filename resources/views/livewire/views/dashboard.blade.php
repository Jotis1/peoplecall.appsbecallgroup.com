    ...
    <main class="mx-auto w-full max-w-5xl px-10">
        ...
        <section class="mt-5 flex flex-col items-center gap-5 sm:items-start">
            ...
            <aside class="flex flex-wrap items-center gap-5">
                <article
                    class="mx-auto flex h-40 min-w-72 flex-col items-center justify-around gap-2.5 rounded-md bg-ctp-mantle p-5"
                >
        ...
        <section class="my-5 flex flex-col items-center gap-5 sm:items-start">
            ...
            @else
                <form action="post-csv" method="POST" class="flex flex-col gap-5" enctype="multipart/form-data">
                    ...
                    <aside
                        class="relative flex h-40 w-full max-w-80 items-center justify-center rounded-md border-2 border-dashed border-ctp-blue bg-ctp-mantle p-5 text-center text-ctp-subtext0"
                    >
                    ...
                    <section
                        id="file-section"
                        class="hidden w-full max-w-80 items-center justify-between rounded-md bg-ctp-mantle px-5 py-2 text-ctp-blue"
                    >
                        <p>Archivo.csv</p>
                    ...
                    <button
                        type="submit"
                        id="submit-button"
                        class="hidden h-10 w-fit items-center justify-center rounded-md bg-ctp-blue p-5 px-5 text-center text-ctp-crust"
                    >
